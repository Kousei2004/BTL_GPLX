...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Liên kết các EditText với XML
        usernameEditText = findViewById(R.id.username_reg);
        passwordEditText = findViewById(R.id.pass_reg);
        confirmPasswordEditText = findViewById(R.id.repass_reg);

        // Khởi tạo các CheckBox
        termsCheckBox = findViewById(R.id.checkbox_terms);
        newsletterCheckBox = findViewById(R.id.checkbox_privacy_policy);
        priCheckBox = findViewById(R.id.checkbox_private);
        ...
        // Sự kiện click cho nút Đăng Nhập Ngay
        findViewById(R.id.btn_dangnhapngay).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
// Hiển thị chính sách khi nhấn vào checkbox "Nhận bản tin"
    ...
    private void registerUser() {
        ...
        // Kiểm tra nếu người dùng đồng ý với điều khoản và đăng ký nhận bản tin
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // Kiểm tra nếu người dùng đăng ký nhận bản tin
                            if (newsletterCheckBox.isChecked()) {
                                // Đăng ký nhận bản tin, ví dụ gửi thông báo, lưu thông tin, v.v.
                                Toast.makeText(RegisterActivity.this, "Đăng ký nhận bản tin thành công", Toast.LENGTH_SHORT).show();
                            }
                        } else {
    ...
    private void showTermsPolicy() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Điều khoản và điều kiện\n\n" +
                        ...
                        "Ứng dụng có nghĩa là chương trình phần mềm do Công ty cung cấp được Bạn tải xuống trên bất kỳ thiết bị điện tử nào có tên là Ôn Thi GPLX A1\n" +
                        ...
                        "Công ty (được gọi là \"Công ty\", \"Chúng tôi\", \"Chúng tôi\" hoặc \"Của chúng tôi\" trong Thỏa thuận này) đề cập đến Ôn Thi GPLX A1.\n" +
    ...
    private void showPrivacyPolicy() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Chính sách bảo mật cho Ôn Thi GPLX A1\n\n" +
                        "CHÍNH SÁCH BẢO MẬT\n\n" +
                        "Cập nhật lần cuối: 18 tháng 11 năm 2024\n" +
                        ...
                        "Công ty liên kết có nghĩa là một thực thể kiểm soát, được kiểm soát bởi hoặc chịu sự kiểm soát chung với một bên, trong đó 'kiểm soát' có nghĩa là sở hữu 50% hoặc nhiều hơn số cổ phiếu, quyền sở hữu vốn chủ sở hữu hoặc chứng khoán khác có quyền biểu quyết bầu giám đốc hoặc cơ quan quản lý khác.\n" +
                        "Ứng dụng này đề cập đến Ôn Thi GPLX A1, chương trình phần mềm do Công ty cung cấp.\n" +
                        "Công ty (được gọi là 'Công ty', 'Chúng tôi', 'Chúng tôi' hoặc 'Của chúng tôi' trong Thỏa thuận này) đề cập đến Ôn Thi GPLX A1.\n" +
                        "Quốc gia đề cập đến: Việt Nam\n" +
                        "Thiết bị có nghĩa là bất kỳ thiết bị nào có thể truy cập Dịch vụ như máy tính, điện thoại di động hoặc máy tính bảng kỹ thuật số.\n" +
                        ...
                        "Liên hệ với chúng tôi: Nếu bạn có bất kỳ câu hỏi nào về Chính sách bảo mật này, bạn có thể liên hệ với chúng tôi qua email: kousei2k4@gmail.com")
                .setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void showPrivatePolicy() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Chính sách quyền riêng tư cho Ôn Thi GPLX A1\n\n" +
                        "Cập nhật lần cuối: 18 tháng 11 năm 2024\n\n" +
                        "Chào mừng bạn đến với ứng dụng Ôn Thi GPLX A1! Chúng tôi hiểu rằng việc bảo vệ thông tin cá nhân của bạn là rất quan trọng. " +
                        ...
                        "Bằng cách tải xuống và sử dụng ứng dụng Ôn Thi GPLX A1, bạn đồng ý với các điều khoản của chính sách này. " +
                        ...
                        "Liên hệ với chúng tôi: Nếu bạn có bất kỳ câu hỏi nào về Chính sách quyền riêng tư này, bạn có thể liên hệ với chúng tôi qua email: kousei2k4@gmail.com")
                .setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
