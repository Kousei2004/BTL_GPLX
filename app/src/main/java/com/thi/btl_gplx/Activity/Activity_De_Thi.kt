...
import com.thi.btl_gplx.databinding.ActivityDethiBinding

class Activity_De_Thi : AppCompatActivity() {
    lateinit var binding: ActivityDethiBinding
    lateinit var quizModelList: MutableList<QuizModel>
    lateinit var adapter: QuizListAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDethiBinding.inflate(layoutInflater)
